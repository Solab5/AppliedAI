...
const PainPoints = () => {
  ...
  return (
    <section ref={sectionRef} className="py-16 bg-white dots-pattern-subtle relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="hidden sm:flex flex-col items-center sm:items-start sm:justify-center sm:w-24 flex-shrink-0">
                  <div className="z-10 mb-3 sm:mb-0 sm:mt-0 mt-2">
                    <div className="w-8 h-8 rounded-full bg-white border-3 border-brand-orange flex items-center justify-center shadow-md mx-auto">
                      <point.icon className="w-4 h-4 text-brand-orange" />
                    </div>
                  </div>
                </div>
                {/* Card */}
        ...
        <div className="text-center mt-16">
          <div className="inline-block bg-gradient-to-r from-brand-orange via-brand-blue to-brand-orange rounded-2xl p-8 shadow-xl border-0">
            <h3 className="text-xl md:text-2xl font-oswald font-bold text-white mb-3 uppercase tracking-wide drop-shadow">
              Sound Familiar?
            </h3>
            <p className="font-roboto-flex text-base text-white/90 mb-6 max-w-xl mx-auto">
              We've helped hundreds of organizations overcome these exact challenges. Let's make your AI/ML initiative a success.
            </p>
            <button className="bg-white/90 hover:bg-white text-brand-brown font-oswald font-semibold px-8 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg uppercase tracking-wide text-sm md:text-base shadow-md">
