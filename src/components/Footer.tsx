      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="font-roboto-flex text-gray-300 mb-6 max-w-md">
              We deliver{' '}
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#services" className="font-roboto-flex text-gray-300 hover:text-brand-orange transition-colors">Services</a></li>
              <li><a href="#approach" className="font-roboto-flex text-gray-300 hover:text-brand-orange transition-colors">Approach</a></li>
              <li><a href="#case-studies" className="font-roboto-flex text-gray-300 hover:text-brand-orange transition-colors">Case Studies</a></li>
              <li><a href="#contact" className="font-roboto-flex text-gray-300 hover:text-brand-orange transition-colors">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="font-roboto-flex text-gray-300">risolab2025@gmail.com
</span>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="w-4 h-4 text-brand-blue" />
                <span className="font-roboto-flex text-gray-300">+256 7777 54234 </span>
              </div>
              <div className="flex items-center gap-3">
                <MapPin className="w-4 h-4 text-brand-orange" />
                <span className="font-roboto-flex text-gray-300">Kampala, Uganda</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-brand-brown/40">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
            <div>
              ...
              <div className="font-roboto-condensed font-light text-gray-400 text-sm uppercase">PROJECTS DELIVERED</div>
            </div>
            <div>
              <div className="text-2xl font-oswald font-bold text-brand-blue mb-1 uppercase">95%</div>
              <div className="font-roboto-condensed font-light text-gray-400 text-sm uppercase">SUCCESS RATE</div>
            </div>
            <div>
              <div className="text-2xl font-oswald font-bold text-brand-orange mb-1 uppercase">$50M+</div>
              <div className="font-roboto-condensed font-light text-gray-400 text-sm uppercase">VALUE GENERATED</div>
            </div>
            <div>
